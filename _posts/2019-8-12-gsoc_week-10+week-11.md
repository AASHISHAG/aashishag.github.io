...
Here are some of the results I obtained after training the model. The script recipe_v2/show_results.sh was used to get these results. These results are based on best_wer file generated by Kaldi.
