...
Parallely, the impostant part of the project is collecting and understand the requisite German Speech dataset. The datasets have different structure and formats. We planned to use the following open-source corpus:
